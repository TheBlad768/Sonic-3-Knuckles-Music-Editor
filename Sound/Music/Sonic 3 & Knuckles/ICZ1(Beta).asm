Snd_ICZ1Beta_Header:
	...
	smpsHeaderVoice     Snd_ICZ1Beta_Voices
	smpsHeaderChan      $07, $03
	smpsHeaderTempo     $01, $19

	smpsHeaderDAC       Snd_ICZ1Beta_DAC
	smpsHeaderFM        Snd_ICZ1Beta_FM1,	$18, $18
	smpsHeaderFM        Snd_ICZ1Beta_FM2,	$0C, $10
	smpsHeaderFM        Snd_ICZ1Beta_FM3,	$0C, $1E
	smpsHeaderFM        Snd_ICZ1Beta_FM4,	$0C, $1E
	smpsHeaderFM        Snd_ICZ1Beta_FM5,	$18, $1B
	smpsHeaderFM        Snd_ICZ1Beta_FM6,	$00, $00
	smpsHeaderPSG       Snd_ICZ1Beta_PSG1,	$00, $03, $00, $00
	smpsHeaderPSG       Snd_ICZ1Beta_PSG2,	$00, $05, $00, $00
	smpsHeaderPSG       Snd_ICZ1Beta_PSG3,	$00, $01, $00, $00
...
Snd_ICZ1Beta_Jump00:
	...
	smpsLoop            $00, $02, Snd_ICZ1Beta_Jump00
	smpsFMAlterVol      $03
	smpsSetvoice        $02
	smpsAlterPitch      $E8
...
Snd_ICZ1Beta_Loop01:
	smpsCall            Snd_ICZ1Beta_Call00
	smpsLoop            $00, $04, Snd_ICZ1Beta_Loop01
...
Snd_ICZ1Beta_Loop02:
	smpsCall            Snd_ICZ1Beta_Call00
	smpsLoop            $00, $06, Snd_ICZ1Beta_Loop02
	smpsJump            Snd_ICZ1Beta_Jump04
...
Snd_ICZ1Beta_Loop00:
	...
	smpsPSGAlterVol     $01
	dc.b	nMaxPSG2, $04, nRst, $08
	smpsLoop            $00, $03, Snd_ICZ1Beta_Loop00
	dc.b	nMaxPSG2, $04, nRst, $08
	smpsPSGAlterVol     $FF
	dc.b	nMaxPSG2, $08, nRst, $04
	smpsPSGAlterVol     $01
