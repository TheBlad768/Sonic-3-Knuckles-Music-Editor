Snd_PresSegaS3_Header:
	smpsHeaderStartSong 3
	smpsHeaderVoice     Snd_PresSegaS3_Voices
	smpsHeaderChan      $07, $03
	smpsHeaderTempo     $01, $10

	smpsHeaderDAC       Snd_PresSegaS3_DAC
	smpsHeaderFM        Snd_PresSegaS3_FM1,	$0D, $10
	smpsHeaderFM        Snd_PresSegaS3_FM2,	$0D, $1B
	smpsHeaderFM        Snd_PresSegaS3_FM3,	$01, $05
	smpsHeaderFM        Snd_PresSegaS3_FM4,	$0D, $18
	smpsHeaderFM        Snd_PresSegaS3_FM5,	$0D, $13
	smpsHeaderFM        Snd_PresSegaS3_FM6,	$00, $00
	smpsHeaderPSG       Snd_PresSegaS3_PSG1,	$01, $01, $00, $00
	smpsHeaderPSG       Snd_PresSegaS3_PSG2,	$01, $01, $00, $00
	smpsHeaderPSG       Snd_PresSegaS3_PSG3,	$00, $04, $00, $00

Snd_PresSegaS3_Call02:
...
Snd_PresSegaS3_Call00:
	dc.b	nG4, $06, nF4, nD4, nF4
	smpsReturn

Snd_PresSegaS3_Call01:
...
Snd_PresSegaS3_Loop04:
	smpsFMAlterVol      $FF
	dc.b	smpsNoAttack, nG4, $17
	smpsLoop            $00, $04, Snd_PresSegaS3_Loop04
...
Snd_PresSegaS3_Loop03:
	smpsFMAlterVol      $FF
	dc.b	smpsNoAttack, nB3, $17
	smpsLoop            $00, $04, Snd_PresSegaS3_Loop03
	smpsStop
...
Snd_PresSegaS3_FM3:
	...
	smpsAlterPitch      $F4
	smpsSetvoice        $01
	smpsCall            Snd_PresSegaS3_Call02
	smpsCall            Snd_PresSegaS3_Call03
	dc.b	nE2, $05, nRst, $01, nRst, $06
	smpsCall            Snd_PresSegaS3_Call04
...
Snd_PresSegaS3_Loop00:
	smpsCall            Snd_PresSegaS3_Call00
	smpsLoop            $00, $08, Snd_PresSegaS3_Loop00

Snd_PresSegaS3_Loop01:
	smpsCall            Snd_PresSegaS3_Call01
	smpsLoop            $00, $04, Snd_PresSegaS3_Loop01

Snd_PresSegaS3_Loop02:
	smpsCall            Snd_PresSegaS3_Call00
	smpsLoop            $00, $04, Snd_PresSegaS3_Loop02
	smpsPan             panLeft, $00
	smpsStop
...
Snd_PresSegaS3_Loop05:
	...
	dc.b	nMaxPSG2, $06, nMaxPSG2
	smpsPSGAlterVol     $04
	smpsLoop            $00, $03, Snd_PresSegaS3_Loop05
	dc.b	nMaxPSG2, $06, nMaxPSG2
	smpsPSGAlterVol     $FC
	dc.b	nMaxPSG2, $06, nMaxPSG2
	smpsPSGAlterVol     $04
