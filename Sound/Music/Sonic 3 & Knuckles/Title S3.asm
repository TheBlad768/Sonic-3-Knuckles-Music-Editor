Snd_TitleS3_Header:
	...
	smpsHeaderVoice     Snd_TitleS3_Voices
	smpsHeaderChan      $07, $03
	smpsHeaderTempo     $01, $02

	smpsHeaderDAC       Snd_TitleS3_DAC
	smpsHeaderFM        Snd_TitleS3_FM1,	$18, $10
	smpsHeaderFM        Snd_TitleS3_FM2,	$18, $1B
	smpsHeaderFM        Snd_TitleS3_FM3,	$00, $05
	smpsHeaderFM        Snd_TitleS3_FM4,	$18, $18
	smpsHeaderFM        Snd_TitleS3_FM5,	$18, $13
	smpsHeaderFM        Snd_TitleS3_FM6,	$00, $00
	smpsHeaderPSG       Snd_TitleS3_PSG1,	$00, $01, $00, $00
	smpsHeaderPSG       Snd_TitleS3_PSG2,	$00, $01, $00, $00
	smpsHeaderPSG       Snd_TitleS3_PSG3,	$00, $04, $00, $00
...
Snd_TitleS3_Loop07:
	smpsCall            Snd_TitleS3_Call03
	smpsLoop            $00, $04, Snd_TitleS3_Loop07
	smpsStop
...
Snd_TitleS3_FM3:
	...
	smpsCall            Snd_TitleS3_Call04
	smpsCall            Snd_TitleS3_Call05
	dc.b	nE2, $05, nRst, $01, nRst, $06
	smpsCall            Snd_TitleS3_Call06
...
Snd_TitleS3_Loop00:
	smpsCall            Snd_TitleS3_Call00
	smpsLoop            $00, $08, Snd_TitleS3_Loop00

Snd_TitleS3_Loop01:
	smpsCall            Snd_TitleS3_Call01
	smpsLoop            $00, $04, Snd_TitleS3_Loop01

Snd_TitleS3_Loop02:
	smpsCall            Snd_TitleS3_Call02
	smpsLoop            $00, $04, Snd_TitleS3_Loop02

Snd_TitleS3_Loop03:
	smpsCall            Snd_TitleS3_Call00
	smpsLoop            $00, $08, Snd_TitleS3_Loop03

Snd_TitleS3_Loop04:
	smpsCall            Snd_TitleS3_Call01
	smpsLoop            $00, $04, Snd_TitleS3_Loop04

Snd_TitleS3_Loop05:
	smpsCall            Snd_TitleS3_Call00
	smpsLoop            $00, $04, Snd_TitleS3_Loop05
	smpsPan             panLeft, $00

Snd_TitleS3_Loop06:
	smpsCall            Snd_TitleS3_Call03
	smpsLoop            $00, $04, Snd_TitleS3_Loop06
	smpsStop
...
Snd_TitleS3_Loop08:
	...
	dc.b	nMaxPSG2, $06, nMaxPSG2
	smpsPSGAlterVol     $04
	smpsLoop            $00, $08, Snd_TitleS3_Loop08
	dc.b	nMaxPSG2, $06, nMaxPSG2
	smpsPSGAlterVol     $FC
	dc.b	nMaxPSG2, $06, nMaxPSG2
	smpsPSGAlterVol     $04
