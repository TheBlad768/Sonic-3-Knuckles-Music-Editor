Snd_CNZ1Beta_Header:
	...
	smpsHeaderDAC       Snd_CNZ1Beta_DAC,	$00, $0A
	smpsHeaderFM        Snd_CNZ1Beta_FM1,		$03, $15
	smpsHeaderFM        Snd_CNZ1Beta_FM2,	$03, $15
	smpsHeaderFM        Snd_CNZ1Beta_FM3,	$03, $14
	smpsHeaderFM        Snd_CNZ1Beta_FM4,	$1B, $12
	smpsHeaderFM        Snd_CNZ1Beta_FM5,	$03, $18
	smpsHeaderFM        Snd_CNZ1Beta_FM6,	$00, $00
	smpsHeaderPSG       Snd_CNZ1Beta_PSG1,	$03, $05, $00, sTone_0C
	smpsHeaderPSG       Snd_CNZ1Beta_PSG2,	$03, $05, $00, sTone_0C
	smpsHeaderPSG       Snd_CNZ1Beta_PSG3,	$00, $03, $00, sTone_0C
...
Snd_CNZ1Beta_Loop00:
	...
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $34
	smpsLoop            $01, $02, Snd_CNZ1Beta_Loop00
...
Snd_CNZ1Beta_Loop01:
	...
	smpsPSGvoice        sTone_08
	dc.b	nMaxPSG1, $0C
	smpsLoop            $01, $07, Snd_CNZ1Beta_Loop01
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $08
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $04
...
Snd_CNZ1Beta_Loop02:
	...
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $0C
	smpsLoop            $01, $03, Snd_CNZ1Beta_Loop02
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $08
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $04
...
Snd_CNZ1Beta_Loop03:
	...
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $0C
	smpsLoop            $01, $03, Snd_CNZ1Beta_Loop03
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $08
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $04
...
Snd_CNZ1Beta_Loop04:
	...
	smpsPSGvoice        sTone_08
	dc.b	nMaxPSG1, $0C
	smpsLoop            $01, $1E, Snd_CNZ1Beta_Loop04
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $08
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $04
