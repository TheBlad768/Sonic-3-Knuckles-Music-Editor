Snd_CNZ2Beta_Header:
	...
	smpsHeaderDAC       Snd_CNZ2Beta_DAC
	smpsHeaderFM        Snd_CNZ2Beta_FM1,	$0C, $13
	smpsHeaderFM        Snd_CNZ2Beta_FM2,	$0C, $13
	smpsHeaderFM        Snd_CNZ2Beta_FM3,	$18, $18
	smpsHeaderFM        Snd_CNZ2Beta_FM4,	$18, $0C
	smpsHeaderFM        Snd_CNZ2Beta_FM5,	$0C, $18
	smpsHeaderFM        Snd_CNZ2Beta_FM6,	$00, $00
	smpsHeaderPSG       Snd_CNZ2Beta_PSG1,	$F4, $05, $00, sTone_0C
	smpsHeaderPSG       Snd_CNZ2Beta_PSG2,	$F4, $05, $00, sTone_0C
	smpsHeaderPSG       Snd_CNZ2Beta_PSG3,	$00, $03, $00, sTone_0C
...
Snd_CNZ2Beta_Loop00:
	...
	dc.b	nMaxPSG1, $0C
	smpsLoop            $01, $0D, Snd_CNZ2Beta_Loop00
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $06
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $06
...
Snd_CNZ2Beta_Loop01:
	...
	smpsPSGvoice        sTone_08
	dc.b	nMaxPSG1, $0C
	smpsLoop            $01, $0D, Snd_CNZ2Beta_Loop01
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $06
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $06
...
Snd_CNZ2Beta_Loop02:
	...
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $06
	smpsLoop            $01, $08, Snd_CNZ2Beta_Loop02
...
Snd_CNZ2Beta_Loop03:
	...
	smpsPSGvoice        sTone_08
	dc.b	nMaxPSG1, $0C
	smpsLoop            $01, $06, Snd_CNZ2Beta_Loop03
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $06
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG1, $06
