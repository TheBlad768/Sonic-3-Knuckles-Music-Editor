Snd_StaffRoll_Header:
	smpsHeaderStartSong 3
	smpsHeaderVoice     Snd_StaffRoll_Voices
	smpsHeaderChan      $07, $03
	smpsHeaderTempo     $01, $30

	smpsHeaderDAC       Snd_StaffRoll_DAC
	smpsHeaderFM        Snd_StaffRoll_FM1,	$00, $15
	smpsHeaderFM        Snd_StaffRoll_FM2,	$0C, $0E
	smpsHeaderFM        Snd_StaffRoll_FM3,	$00, $0D
	smpsHeaderFM        Snd_StaffRoll_FM4,	$0C, $1E
	smpsHeaderFM        Snd_StaffRoll_FM5,	$00, $1A
	smpsHeaderFM        Snd_StaffRoll_FM6,	$00, $00
	smpsHeaderPSG       Snd_StaffRoll_PSG1,	$F4, $05, $00, $00
	smpsHeaderPSG       Snd_StaffRoll_PSG2,	$F4, $05, $00, $00
	smpsHeaderPSG       Snd_StaffRoll_PSG3,	$23, $04, $00, $00
...
Snd_StaffRoll_Loop04:
	...
	smpsFMAlterVol      $03
	smpsLoop            $00, $02, Snd_StaffRoll_Loop04
	smpsJump            Snd_StaffRoll_Jump01
...
Snd_StaffRoll_Loop01:
	dc.b	nAb1, $06, nRst, nAb1, nRst, $4E
	smpsLoop            $00, $09, Snd_StaffRoll_Loop01

Snd_StaffRoll_Loop02:
	...
	smpsLoop            $00, $02, Snd_StaffRoll_Loop02

Snd_StaffRoll_Loop03:
	...
	smpsLoop            $00, $02, Snd_StaffRoll_Loop03
...
Snd_StaffRoll_Loop06:
	...
	dc.b	nC4, $60
	smpsPSGAlterVol     $03
	smpsLoop            $00, $02, Snd_StaffRoll_Loop06
	smpsPSGvoice        sTone_1D
	smpsPSGAlterVol     $FE
...
Snd_StaffRoll_Loop05:
	...
	dc.b	nAb3, $60
	smpsPSGAlterVol     $03
	smpsLoop            $00, $02, Snd_StaffRoll_Loop05
	smpsPSGAlterVol     $FE
	smpsPSGvoice        sTone_1D
	dc.b	nFs3, $30, nBb3, nAb3, nEb4, nAb3, nC4, nF3, $18, nF3, nD4, nF3
	dc.b	$0C, nF3, nFs3, $30, nBb3, nAb3, nEb4, nAb3, nC4, nF3, $18, nF3
	...
	dc.b	nRst, $42
	smpsPSGAlterVol     $02
	smpsJump            Snd_StaffRoll_PSG2

; PSG3 Data
Snd_StaffRoll_PSG3:
	smpsPSGform         $E7
	smpsCall            Snd_StaffRoll_Call00
	smpsCall            Snd_StaffRoll_Call01
	...
	smpsCall            Snd_StaffRoll_Call02
	smpsCall            Snd_StaffRoll_Call02
	smpsCall            Snd_StaffRoll_Call03
	smpsPSGvoice        sTone_0F
	dc.b	(nMaxPSG2-$23)&$FF, $06, (nMaxPSG2-$23)&$FF
	smpsPSGvoice        sTone_12
	dc.b	$0C
	...
	smpsCall            Snd_StaffRoll_Call00
	smpsCall            Snd_StaffRoll_Call01
	smpsJump            Snd_StaffRoll_PSG3

Snd_StaffRoll_Call00:
	smpsPSGvoice        sTone_0F
	dc.b	(nMaxPSG2-$23)&$FF, $06, (nMaxPSG2-$23)&$FF
	smpsPSGvoice        sTone_12
	dc.b	$0C
	smpsLoop            $00, $10, Snd_StaffRoll_Call00
	smpsReturn

Snd_StaffRoll_Call01:
	smpsPSGvoice        sTone_0F
	dc.b	(nMaxPSG2-$23)&$FF, $06, (nMaxPSG2-$23)&$FF
	smpsPSGvoice        sTone_12
	dc.b	(nMaxPSG2-$23)&$FF
	smpsPSGvoice        sTone_0F
	dc.b	(nMaxPSG2-$23)&$FF
	smpsLoop            $00, $10, Snd_StaffRoll_Call01
	smpsReturn

Snd_StaffRoll_Call02:
	smpsPSGvoice        sTone_0F
	...
	smpsPSGvoice        sTone_0F
	dc.b	$06, $06
	smpsLoop            $00, $04, Snd_StaffRoll_Call02
	smpsReturn

Snd_StaffRoll_Call03:
	smpsPSGvoice        sTone_0F
	...
	smpsLoop            $00, $07, Snd_StaffRoll_Call03
	smpsReturn
...
Snd_StaffRoll_Loop00:
	...
	smpsLoop            $00, $02, Snd_StaffRoll_Loop00
...
Snd_StaffRoll_Jump00:
	...
	dc.b	dFloorTomS3
	smpsJump            Snd_StaffRoll_Jump00

Snd_StaffRoll_Voices:
