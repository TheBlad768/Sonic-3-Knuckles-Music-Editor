...
SMPS_PauseMusic macro
	move.b	#1,(Clone_Driver_RAM+SMPS_RAM.f_stopmusic).l
	endm
...
SMPS_UnpauseMusic macro
	move.b	#$80,(Clone_Driver_RAM+SMPS_RAM.f_stopmusic).l
	endm
...
;	move	#$2300,sr					; enable interrupts (we can accept horizontal interrupts from now on)
	bset	#0,(Clone_Driver_RAM+SMPS_RAM.SMPS_running_flag).l	; set "SMPS running flag"
	bne.s	+						; if it was set already, don't call another instance of SMPS
	jsr	(SMPS_UpdateDriver).l 				; update Sonic 2 Clone Driver v2
	clr.b	(Clone_Driver_RAM+SMPS_RAM.SMPS_running_flag).l	; reset "SMPS running flag"
+
	endm
